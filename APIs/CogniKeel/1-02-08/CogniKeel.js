...
// 1-02-08 LayerにgetObjectNameを追加し、getMCLMのLayerの名前をgetKindからgetObjectNameに変更(例:#DenseLayer->#Dense)。
// CogniKeelにstaticでfromMCLMを追加し、MCLMからCogniKeelインスタンス(ready)を生成。
